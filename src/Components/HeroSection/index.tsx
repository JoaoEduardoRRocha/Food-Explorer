  ...
  return (
      <section className='section-content'>
        ...
        <div className='section-content__text-content'>
          <h1 className='section-content__text-content__h1'>Sabores inigualáveis</h1>
          <h3 className='section-content__text-content__h2'>Sinta o cuidado do preparo com ingredientes selecionados</h3>
        </div>
      </section>
  );
};
